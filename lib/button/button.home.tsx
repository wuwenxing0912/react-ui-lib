	...
	return (
		<section>
			...
			<div className="example-container">
				<Button type="default" className="default" style={{ marginRight: 20 }}>
					Default
				</Button>
			...
			<div className="description">
				<span className='text'>按钮有四种类型：默认按钮、主题按钮、虚线按钮以及危险按钮。</span>
        ...
        <span className='pop-content'>显示代码</span>
			</div>
			<div className="code-area" style={{ display: visible ? "block" : "none" }}>
